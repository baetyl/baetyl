...
import (
	...
	sdk "github.com/baetyl/baetyl/sdk/baetyl-go"
...
func TestInitVolumes(t *testing.T) {
	...
	vs := make(map[string]sdk.ComposeVolume)
	opts := make(map[string]string)
	labels := make(map[string]string)
	vs["baetyl1"] = sdk.ComposeVolume{
		Driver:     "local",
		DriverOpts: opts,
		Labels:     labels,
	}
	vs["baetyl2"] = sdk.ComposeVolume{
		Driver:     "local",
		DriverOpts: opts,
		Labels:     labels,
	}
