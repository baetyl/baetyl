...
func NewDockerContainer(s *DockerSpec) Worker {
	return &DockerContainer{
		spec: s,
		log:  openedge.WithField("module", s.module.UniqueName()),
	}
}
...
// RestartPolicy returns restart policy
func (w *DockerContainer) RestartPolicy() RestartPolicyInfo {
...
func (w *DockerContainer) Stats() (*ModuleStats, error) {
	ctx := context.Background()
