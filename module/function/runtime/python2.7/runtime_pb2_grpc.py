...
class RuntimeStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Handle = channel.unary_unary(
        ...
        request_serializer=runtime__pb2.Message.SerializeToString,
        response_deserializer=runtime__pb2.Message.FromString,
        )
...
def add_RuntimeServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Handle': grpc.unary_unary_rpc_method_handler(
          servicer.Handle,
          request_deserializer=runtime__pb2.Message.FromString,
          response_serializer=runtime__pb2.Message.SerializeToString,
      ),
  }
