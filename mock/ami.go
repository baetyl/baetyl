...
// Source: github.com/baetyl/baetyl-core/engine (interfaces: AMI)
...
// CollectAppStatus mocks base method.
func (m *MockAMI) CollectAppStatus(arg0 string) ([]v1.AppStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CollectAppStatus", arg0)
	ret0, _ := ret[0].([]v1.AppStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CollectAppStatus indicates an expected call of CollectAppStatus.
func (mr *MockAMIMockRecorder) CollectAppStatus(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CollectAppStatus", reflect.TypeOf((*MockAMI)(nil).CollectAppStatus), arg0)
}
...
func (m *MockAMI) CollectNodeStats() (*v1.NodeStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CollectNodeStats")
	ret0, _ := ret[0].(*v1.NodeStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
