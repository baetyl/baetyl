...
![](./doc/zh-cn/images/overview/design/mode_docker.png)

Native进程模式设计架构图：

![](./doc/zh-cn/images/overview/design/mode_native.png)
...
> + 如果您有更好的关于OpenEdge的发展建议，欢迎通过电子邮件方式与我们联系[contact@openedge.tech](contact@openedge.tech)