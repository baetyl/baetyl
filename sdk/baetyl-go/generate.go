...
//go:generate ./templates/gen.sh baetyl-agent
//go:generate ./templates/gen.sh baetyl-hub
//go:generate ./templates/gen.sh baetyl-remote-mqtt
//go:generate ./templates/gen.sh baetyl-timer
