...
func TestGetServiceLog(t *testing.T) {
	...
	url := fmt.Sprintf("%s%s", "httplink://127.0.0.1:50030", "/services/service1/log?tailLines=10&sinceSeconds=60")
	...
	url2 := fmt.Sprintf("%s%s", "httplink://127.0.0.1:50030", "/services/unknown/log?tailLines=10&sinceSeconds=60")
	...
	url3 := fmt.Sprintf("%s%s", "httplink://127.0.0.1:50030", "/services/unknown/log?tailLines=a&sinceSeconds=12")
	...
	url4 := fmt.Sprintf("%s%s", "httplink://127.0.0.1:50030", "/services/unknown/log?tailLines=12&sinceSeconds=a")
