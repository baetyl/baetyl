...
![基于Function模块实现设备消息处理流程](../../images/develop/guide/remote/openedge-remote-flow.png)
...
![基于Baidu IoT Hub创建的endpoint下属设备信息](../../images/develop/guide/remote/cloud-iothub-user-config.png)
