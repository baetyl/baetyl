...
Read [Build Baetyl From Source](../setup/Build-Baetyl-from-Source.md) before developing custom modules to understand Baetyl's build environment requirements.
