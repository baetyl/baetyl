...
if ! /usr/bin/getent group docker >/dev/null; then
    echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo ""
    echo " WARNING: docker is uninstalled!"
    echo ""
...
if [ ! -x /usr/bin/systemctl ]; then
    echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
    echo ""
    echo " WARNING: systemd is uninstalled!"
    echo ""
    echo " OpenEdge need be supervised by daemon tools, such as systemd or supervisor."
...
echo ""
echo "  About configurations or design of OpenEdge, please visit "
echo ""
echo "  https://openedge.tech/en/docs/overview/OpenEdge-design for help."
echo ""
echo "  OpenEdge is running in docker container mode defaultly. Meantime OpenEdge "
echo "  support native process mode. "
echo ""
echo "  If you need run openedge in native mode, please visit"
echo "  https://openedge.tech/zh/docs/setup/Build-OpenEdge-from-Source for help." 
echo ""
echo "==============================================================================="
