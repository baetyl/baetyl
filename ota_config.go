...
type Metadata struct {
	...
	Volumes []schema0.VolumeInfo `yaml:"volumes" json:"volumes" default:"[]"`
}

type DeployConfig struct {
	AppConfig schema.ComposeAppConfig       `yaml:"appConfig" json:"appConfig"`
	Metadata  map[string]schema0.VolumeInfo `yaml:"metadata" json:"metadata" default:"{}"`
}
...
type ForwardInfo struct {
	...
	// FIXME Status     *inspect          `yaml:"status" json:"status"`                      // node update
